        ...
        <div id="divCenter" class="col-md-10">
            <div id="topbar" style="background: white">
                ...
                <table width="100%" border="0">
                    <tr>
                        <td width="400px">
                            <button id="btnBackward" type="button" class="btn btn-danger" onclick="backward()" disabled=true>撤销</button>
                            <button id="btnForward" type="button" class="btn btn-warning" onclick="forward()" disabled=true>恢复</button>
                            <button id="btnSelectFile" type="button" class="btn btn-primary" onclick="selectFile()">选择文件</button>
