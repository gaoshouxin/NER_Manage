	...
	<div id ="page-wrapper">
		<div class="col-lg-6 ">
			<form role="form">
				<div class="form-group"  >
					<label>选择待识别文件</label>
					<select class="form-control" id = "select_file">
					</select>
					<select id="file_url" style="display:none"></select>
				</div>
				<button style="width:100%" id="identity" type="button" class="btn btn-info" onclick="identityText()">实体识别</button>
			</form>
		</div>
		<div class="col-lg-6 ">
			<form role="form">
				...
				<button style="width:100%" id="btnDownload" type="button" class="btn btn-info" onclick="download()">下载标注结果</button>
			</form>
		</div>
		...
		<div class="col-lg-12">
			<div  style="font-size:20px" onmouseup="markupElement(event)" >
				<ol id="markupTextHtml" style="line-height:30px;">
				</ol>
			</div>
		</div>
	</div>
...
function identityText() {
	...
	selectIndex =  $("#select_model option:selected").index();
